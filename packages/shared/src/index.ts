...
export type { Product, CreateProductDto, UpdateProductDto } from './types/product.js';
export type { BankAccount, CreateBankAccountDto, UpdateBankAccountDto } from './types/bank-account.js';
